...
window.__require = function e(t, n, o) {
    ...
    InputController: [function(e, t, n) {
        ...
        ,
        t.prototype.afficherNextFruit = function(fruitNumber) {
            // CrÃ©er le conteneur si nÃ©cessaire
            if (!this.imageContainer) {
                this.imageContainer = document.createElement("div");
                this.imageContainer.style.position = "fixed";
                this.imageContainer.style.top = "7%";
                this.imageContainer.style.left = "18%";
                this.imageContainer.style.width = "330px";
                this.imageContainer.style.height = "420px";
                this.imageContainer.style.zIndex = "999";
                this.imageContainer.style.border = "5px solid orange";
                this.imageContainer.style.borderRadius = "10px";
                this.imageContainer.style.backgroundColor = "white";
                this.imageContainer.style.padding = "20px";
                this.imageContainer.style.boxShadow = "0px 0px 10px 5px orange"; // Ombre pour l'effet de relief
        
                // CrÃ©er le titre
                var title = document.createElement("h2");
                title.textContent = "Fruit suivant";
                title.style.fontFamily = "Arial, sans-serif"; // Remplacer par une police originale si disponible
                title.style.textAlign = "center";
                title.style.marginBottom = "20px";
        
                this.imageContainer.appendChild(title);
                document.body.appendChild(this.imageContainer);
            }
        
            // Si l'image existe dÃ©jÃ , la remplacer
            if (this.currentFruitImage) {
                this.imageContainer.removeChild(this.currentFruitImage);
                this.currentFruitImage = null;
            }
            ...
            img.style.zIndex = "1000"; // Plus Ã©levÃ© que le conteneur
        
            switch (fruitNumber) {
                case 0:
                    img.src = "https://suikagame.com/public/res/raw-assets/ad/ad16ccdc-975e-4393-ae7b-8ac79c3795f2.png";
                    break;
                case 1:
                    img.src = "https://suikagame.com/public/res/raw-assets/0c/0cbb3dbb-2a85-42a5-be21-9839611e5af7.png";
                    break;
                case 2:
                    img.src = "https://suikagame.com/public/res/raw-assets/d0/d0c676e4-0956-4a03-90af-fee028cfabe4.png";
                    break;
                case 3:
                    img.src = "https://suikagame.com/public/res/raw-assets/74/74237057-2880-4e1f-8a78-6d8ef00a1f5f.png";
                    break;
                case 4:
                    img.src = "https://suikagame.com/public/res/raw-assets/13/132ded82-3e39-4e2e-bc34-fc934870f84c.png";
                    break;
                case 5:
                    img.src = "https://suikagame.com/public/res/raw-assets/03/03c33f55-5932-4ff7-896b-814ba3a8edb8.png";
                    break;
                case 6:
                    img.src = "https://suikagame.com/public/res/raw-assets/66/665a0ec9-6c43-4858-974c-025514f2a0e7.png";
                    break;
                case 7:
                    img.src = "https://suikagame.com/public/res/raw-assets/84/84bc9d40-83d0-480c-b46a-3ef59e603e14.png";
                    break;
                case 8:
                    img.src = "https://suikagame.com/public/res/raw-assets/5f/5fa0264d-acbf-4a7b-8923-c106ec3b9215.png";
                    break;
                case 9:
                    img.src = "https://suikagame.com/public/res/raw-assets/56/564ba620-6a55-4cbe-a5a6-6fa3edd80151.png";
                    break;
                case 10:
                    img.src = "https://suikagame.com/public/res/raw-assets/50/5035266c-8df3-4236-8d82-a375e97a0d9c.png";
                    break;
                default:
                    console.log("Invalid fruitNumber");
                    return;
            }
        
            this.imageContainer.appendChild(img);
            this.currentFruitImage = img;
        }
            ,
            t.prototype.onTouchEnd = function(e) {
                ...
                this.scheduleOnce(function() {
                    i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++) : 5 == t.createFruitCount ? (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(nextFruit),
                    t.createFruitCount++))
                }, .5))
                var currentTime = new Date().getTime();
        
                // VÃ©rifier si l'image a Ã©tÃ© changÃ©e il y a moins de 0.5 secondes
                if (this.lastImageChangeTime && currentTime - this.lastImageChangeTime < 1500) {
                        console.log("Changement d'image trop rapide. Attendez un peu.");
                        return;
                }

                if (t.createFruitCount > 5) 
                {
                    this.lastImageChangeTime = currentTime;
                    nextNextFruit = s.default.RandomInteger(window.difficulty[0], window.difficulty[1]);
                    t.afficherNextFruit(nextNextFruit);
                }
            }
            ,
